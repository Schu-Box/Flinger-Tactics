...
public class RuleSet {
	...
	public RuleSet() {
		...
		ruleSlotList.Add(new RuleSlot("athleteFieldCount", new List<Rule> { 
		...
		ruleSlotList.Add(new RuleSlot("athleteRosterCount", new List<Rule> { 
			...
			new Rule(7, "Seven-Athlete Roster", "Increase the number of athletes on each team's roster to 7.")
		}));
