...
public class ModeController : MonoBehaviour {
    ...
    void Update() {
        if(Input.GetButtonDown("Submit")) {
            ...
            matchController.GetMatchData().SetWinner(matchController.GetTeam(true));
    ...
    public void EndMatch(MatchData md) {
        ...
        int totalTeamWins = PlayerPrefs.GetInt(md.winner.name, 0);
        totalTeamWins++;
        PlayerPrefs.SetInt(md.winner.name, totalTeamWins);
    }
