...
public class BallController : MonoBehaviour {
	...
	private Coroutine innerColorFadeCoroutine;
	...
	private void FlashColor(Color newColor) {
		if(innerColorFadeCoroutine != null) {
			StopCoroutine(innerColorFadeCoroutine);
		}
	...
	private void StoppedMoving() {
		...
		innerColorFadeCoroutine = StartCoroutine(FadeSprite(lightSlot));
